...
const PII_TYPE_COLORS = {
  ...
  medical_record: 'bg-pink-100 text-pink-800 border-pink-300',
  financial: 'bg-indigo-100 text-indigo-800 border-indigo-300',
  bank_account: 'bg-indigo-100 text-indigo-800 border-indigo-300',
  api_key: 'bg-red-200 text-red-900 border-red-400',
  ipv4: 'bg-cyan-100 text-cyan-800 border-cyan-300',
  ipv6: 'bg-cyan-100 text-cyan-800 border-cyan-300',
  date_of_birth: 'bg-amber-100 text-amber-800 border-amber-300',
  aadhaar: 'bg-violet-100 text-violet-800 border-violet-300',
  pan: 'bg-fuchsia-100 text-fuchsia-800 border-fuchsia-300',
